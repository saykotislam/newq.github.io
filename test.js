...
// Key 1, matches options 4 then push(adviceMapping[1]
// Key 2, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 3, matches options 2, 3 then push(adviceMapping[1]
// Key 3, matches options 4 then push(adviceMapping[1]
// Key 5, matches options 3, 4 then push(adviceMapping[1]
// Key 5, matches options 1,2 then push(adviceMapping[1]
// Key 6, matches options 4 then push(adviceMapping[1]
// Key 7, matches options 0, 1, 2 then push(adviceMapping[1]
// Key 8, matches options 0, 1, 2, 3 then push(adviceMapping[1]
// Key 9, matches options 0, 1, 2, 3 then push(adviceMapping[1]
// Key 10, matches options 3, 4 then push(adviceMapping[1]
// Key 11, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 12, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 13, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 14, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 15, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 16, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 17, matches options 0, 1 then push(adviceMapping[1]
// Key 18, matches option 3 then push(adviceMapping[1]
// Key 19, matches option 4 then push(adviceMapping[1]
 // Key 20, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 21, matches options 2, 3, 4 then push(adviceMapping[1]
// Key 22, matches options 2, 3, 4 then push(adviceMapping[1]
 // Key 23, matches options 0, 1, 2, 3, 4 then push(adviceMapping[1]
// Key 24, matches options 2, 3, 4 then push(adviceMapping[1]
